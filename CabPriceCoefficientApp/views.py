...
class CabPriceCoefficientView(APIView):
    ...
    def __int__(self):
        self.redis = RedisDataBaseAccessObject()
    ...
    def _set_request_id_in_redis(self, data, address_of_the_cab):
        ...
        self.redis.set_request_id(request_id)
        return request_id

    def _get_price_coefficient_from_request_threshold(self, request_id):
        number_of_requests_in_cab_location = self.redis.get_number_of_cabs_in_specific_origin(request_id)
